...
def check_lesson_permission(lesson_id):
	...
	frappe.throw(_("You don't have permission to manage this lesson"), frappe.PermissionError)
...
def get_lmsa_openapi_spec():
	...
	return {
		...
		"paths": {
			"/api/method/lms.lms.ai.api.start_lesson_ingestion": {
				"post": {
			...
			"/api/method/lms.lms.ai.api.get_lesson_ingestion_status": {
				"get": {
										...
										"properties": {
											"message": {
												...
												"properties": {
													"status": {"type": "string"},
													"chunk_count": {"type": "integer"},
													"last_ingested_on": {"type": "string", "nullable": True},
