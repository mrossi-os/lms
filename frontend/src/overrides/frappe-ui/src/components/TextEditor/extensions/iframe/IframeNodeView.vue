<!--
  Override of frappe-ui's TextEditor IframeNodeView.vue via the osOverrideTheme
  Vite plugin. ONLY change from upstream: the "Add caption" placeholder is
  wrapped in __() so it is translatable; the ./utils import is repointed at the
  original in node_modules. Keep in sync with
