...
const refusal = computed(() => {
	...
	// OSLMS-CUSTOM: the Docente (global instructor) manages batch settings too, see batch-detail-docente-admin
	if (!user.data?.is_moderator && !user.data?.is_evaluator && !user.data?.is_docente) {
