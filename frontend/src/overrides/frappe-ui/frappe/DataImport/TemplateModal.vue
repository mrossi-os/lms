    ...
    <Dialog v-model="show" :options="{
            ...
            <div class="text-base space-y-5">
                ...
                <div class="border-t">
                    <p class="mt-2 text-ink-gray-5">
                        {{ __('Select the fields you want to include in the template.') }}
                    </p>
                    <div class="space-x-2 mt-2 mb-5">
                        <Button :label="__('Select All')" @click="selectAllFields" />
                        <Button :label="__('Select Mandatory Fields')" @click="selectMandatoryFields" />
                        <Button :label="__('Unselect All')" @click="unselectAllFields" />
                    </div>
                    <div class="space-y-8">
        ...
        <template #actions="{ close }">
            <div class="flex justify-end space-x-2">
                <Button :label="__('Export')" variant="solid" @click="handleExport" />
