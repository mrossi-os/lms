			...
			<Popover>
				<template #target="{ togglePopover }">
					<button
						...
						class="flex w-full items-center gap-x-2 focus:outline-none bg-surface-gray-2 rounded h-7 py-1.5 px-2 hover:bg-surface-gray-3 focus:bg-surface-white border border-outline-gray-1 hover:border-outline-gray-modals focus:border-outline-gray-4"
					>
						<component
							v-if="selectedIcon"
