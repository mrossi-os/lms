<template>
	<div v-if="sessionStore().user" class="p-4 border rounded-md card">
		<!-- Saluto -->
		...
		<div v-else>
			...
			<div class="flex items-center gap-2 flex-wrap">
				...
				<router-link
					v-if="resumeRoute"
					:to="resumeRoute"
					class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-sm font-medium bg-surface-gray-2 hover:bg-surface-gray-3 text-ink-gray-8 transition-colors"
				>
				...
				<!-- Esplora corso -->
				<router-link
					v-if="lastActiveCourse"
					:to="{
						name: 'CourseDetail',
						params: { courseName: lastActiveCourse },
					}"
					class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-sm font-medium bg-surface-gray-2 hover:bg-surface-gray-3 text-ink-gray-8 transition-colors"
				>
