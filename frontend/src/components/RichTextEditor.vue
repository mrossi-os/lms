...
const props = withDefaults(
	defineProps<{
		...
		// OSLMS-CUSTOM: toolbar items to hide (e.g. InsertIframe in discussions).
		excludeItems?: unknown[]
	}>(),
	{
		content: '',
		editable: true,
...
// OSLMS-CUSTOM: drop the items a caller excludes, keeping the upstream toolbar as is.
const visibleToolbar = computed(() =>
	toolbar.filter((item) => !props.excludeItems.includes(item))
)
