...
import { usesInlinePdfViewer } from '@/utils/pdfViewer'

const screenSize = useScreenSize()
// OSLMS-CUSTOM: Android/mobile browsers get the inline pdf.js viewer too (see utils/pdfViewer)
const inlinePdf = usesInlinePdfViewer()
